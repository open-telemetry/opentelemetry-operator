...
# --parallel 1 (default is 4): the targetallocator-otlp-selftelemetry test does a
...
e2e-targetallocator: chainsaw
	$(CHAINSAW) test --test-dir ./tests/e2e-targetallocator --report-name e2e-targetallocator --parallel 1
