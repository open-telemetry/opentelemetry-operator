...
func TestInstrumentationDefaultingWebhook(t *testing.T) {
	type testCase struct {
		name   string
		input  *types.Instrumentation
		config config.Config
		verify func(t *testing.T, inst *types.Instrumentation)
	}
...
func TestInstrumentationValidatingWebhook_DeprecationWarnings(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{Java: types.Java{VolumeSizeLimit: &defaultSize}}},
		...
		},
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{NodeJS: types.NodeJS{VolumeSizeLimit: &defaultSize}}},
		...
		},
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{Python: types.Python{VolumeSizeLimit: &defaultSize}}},
		...
		},
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{DotNet: types.DotNet{VolumeSizeLimit: &defaultSize}}},
		...
		},
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{Go: types.Go{VolumeSizeLimit: &defaultSize}}},
		...
		},
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{ApacheHttpd: types.ApacheHttpd{VolumeSizeLimit: &defaultSize}}},
		...
		},
		{
			...
			inst: types.Instrumentation{Spec: types.InstrumentationSpec{Nginx: types.Nginx{VolumeSizeLimit: &defaultSize}}},
...
func TestInstrumentationJaegerRemote(t *testing.T) {
	...
	samplers := []types.SamplerType{types.JaegerRemote, types.ParentBasedJaegerRemote}
