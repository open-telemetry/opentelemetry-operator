...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HistogramBucketsItem) DeepCopyInto(out *HistogramBucketsItem) {
	*out = *in
	if in.Buckets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HistogramBucketsItem.
func (in *HistogramBucketsItem) DeepCopy() *HistogramBucketsItem {
	if in == nil {
		return nil
	}
	out := new(HistogramBucketsItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeJS) DeepCopyInto(out *NodeJS) {
	*out = *in
	...
	if in.HistogramBuckets != nil {
		...
		*out = make([]HistogramBucketsItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
