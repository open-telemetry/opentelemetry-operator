...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Deno) DeepCopyInto(out *Deno) {
	*out = *in
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = make([]v1.EnvVar, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Deno.
func (in *Deno) DeepCopy() *Deno {
	if in == nil {
		return nil
	}
	out := new(Deno)
