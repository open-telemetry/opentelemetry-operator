...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CollectorCommand) DeepCopyInto(out *CollectorCommand) {
	*out = *in
	if in.ExtraArgs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CollectorCommand.
func (in *CollectorCommand) DeepCopy() *CollectorCommand {
	if in == nil {
		return nil
	}
	out := new(CollectorCommand)
	in.DeepCopyInto(out)
	return out
}
