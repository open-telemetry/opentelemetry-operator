...
func (in *Apache) DeepCopyInto(out *Apache) {
	*out = *in
	if in.Env != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Apache.
func (in *Apache) DeepCopy() *Apache {
	if in == nil {
		return nil
	}
	out := new(Apache)
