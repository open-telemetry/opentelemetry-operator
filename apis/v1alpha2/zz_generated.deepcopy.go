...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsTelemetry) DeepCopyInto(out *MetricsTelemetry) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsTelemetry.
func (in *MetricsTelemetry) DeepCopy() *MetricsTelemetry {
	if in == nil {
		return nil
	}
	out := new(MetricsTelemetry)
	in.DeepCopyInto(out)
	return out
}
