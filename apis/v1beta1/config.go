...
func hasNullValues(cd *ComponentDefinitions, prefix string) []string {
	var nullKeys []string
	if cd == nil {
		return []string{prefix}
	}
	for key, config := range cd.Object {
...
type ComponentDefinitions struct {
	Object map[string]*AnyConfig `json:"-" yaml:",inline"`
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (c *ComponentDefinitions) DeepCopyInto(out *ComponentDefinitions) {
	*out = *c
	if c.Object != nil {
		in, out := &c.Object, &out.Object
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnyConfig.
func (c *ComponentDefinitions) DeepCopy() *ComponentDefinitions {
	if c == nil {
		return nil
	}
...
// UnmarshalJSON implements an alternative parser for this field.
func (c *ComponentDefinitions) UnmarshalJSON(b []byte) error {
	vals := map[string]*AnyConfig{}
	if err := json.Unmarshal(b, &vals); err != nil {
		return err
	}
	c.Object = vals
...
// MarshalJSON specifies how to convert this object into JSON.
func (c *ComponentDefinitions) MarshalJSON() ([]byte, error) {
	if c == nil {
		return []byte("{}"), nil
	}
	return json.Marshal(c.Object)
