...
// ComponentDefinitions is an alias for AnyConfig that adds component mapping specific methods to
// the AnyConfig.
type ComponentDefinitions AnyConfig

type ReceiverDefinitions ComponentDefinitions
type ProcessorDefinitions ComponentDefinitions
type ExporterDefinitions ComponentDefinitions

func (cd *ReceiverDefinitions) GetPorts(logger logr.Logger) ([]corev1.ServicePort, error) {
	if cd == nil {
		return nil, nil
	}
	return components.GetPortsForConfig(logger, cd.Object, receivers.ReceiverFor)
}

func (cd *ProcessorDefinitions) GetPorts(logger logr.Logger) ([]corev1.ServicePort, error) {
	if cd == nil {
		return nil, nil
	}
	return components.GetPortsForConfig(logger, cd.Object, func(s string) components.ComponentPortParser {
		return nil
	})
}

func (cd *ExporterDefinitions) GetPorts(logger logr.Logger) ([]corev1.ServicePort, error) {
	if cd == nil {
		return nil, nil
	}
	return components.GetPortsForConfig(logger, cd.Object, exporters.ParserFor)
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (cd *ComponentDefinitions) DeepCopyInto(out *ComponentDefinitions) {
	*out = *cd
	if cd.Object != nil {
		in, out := &cd.Object, &out.Object
...
func (cd *ComponentDefinitions) DeepCopy() *ComponentDefinitions {
	if cd == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (cd *ReceiverDefinitions) DeepCopyInto(out *ReceiverDefinitions) {
	*out = *cd
	if cd.Object != nil {
		in, out := &cd.Object, &out.Object
		*out = make(map[string]interface{}, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentDefinitions.
func (cd *ReceiverDefinitions) DeepCopy() *ReceiverDefinitions {
	if cd == nil {
		return nil
	}
	out := new(ReceiverDefinitions)
	cd.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (cd *ProcessorDefinitions) DeepCopyInto(out *ProcessorDefinitions) {
	*out = *cd
	if cd.Object != nil {
		in, out := &cd.Object, &out.Object
		*out = make(map[string]interface{}, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentDefinitions.
func (cd *ProcessorDefinitions) DeepCopy() *ProcessorDefinitions {
	if cd == nil {
		return nil
	}
	out := new(ProcessorDefinitions)
	cd.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (cd *ExporterDefinitions) DeepCopyInto(out *ExporterDefinitions) {
	*out = *cd
	if cd.Object != nil {
		in, out := &cd.Object, &out.Object
		*out = make(map[string]interface{}, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExporterDefinitions.
func (cd *ExporterDefinitions) DeepCopy() *ExporterDefinitions {
	if cd == nil {
		return nil
	}
	out := new(ExporterDefinitions)
	cd.DeepCopyInto(out)
	return out
}
...
type Config struct {
	...
	Receivers ReceiverDefinitions `json:"receivers" yaml:"receivers"`
	// +kubebuilder:pruning:PreserveUnknownFields
	Exporters ExporterDefinitions `json:"exporters" yaml:"exporters"`
	// +kubebuilder:pruning:PreserveUnknownFields
	Processors *ProcessorDefinitions `json:"processors,omitempty" yaml:"processors,omitempty"`
	// +kubebuilder:pruning:PreserveUnknownFields
