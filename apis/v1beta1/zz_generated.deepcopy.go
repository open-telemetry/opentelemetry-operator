...
func (in *TargetAllocatorEmbedded) DeepCopyInto(out *TargetAllocatorEmbedded) {
	*out = *in
	...
	if in.Topology != nil {
		...
		*out = new(TargetAllocatorTopology)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetAllocatorTopology) DeepCopyInto(out *TargetAllocatorTopology) {
	*out = *in
	if in.NodeSyncInterval != nil {
		in, out := &in.NodeSyncInterval, &out.NodeSyncInterval
		*out = new(metav1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetAllocatorTopology.
func (in *TargetAllocatorTopology) DeepCopy() *TargetAllocatorTopology {
	if in == nil {
		return nil
	}
	out := new(TargetAllocatorTopology)
