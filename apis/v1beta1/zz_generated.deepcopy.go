...
func (in *TargetAllocatorEmbedded) DeepCopyInto(out *TargetAllocatorEmbedded) {
	*out = *in
	...
	if in.WeightOverrides != nil {
		...
		*out = make([]TargetAllocatorWeightOverride, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetAllocatorWeightOverride) DeepCopyInto(out *TargetAllocatorWeightOverride) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetAllocatorWeightOverride.
func (in *TargetAllocatorWeightOverride) DeepCopy() *TargetAllocatorWeightOverride {
	if in == nil {
		return nil
	}
	out := new(TargetAllocatorWeightOverride)
	in.DeepCopyInto(out)
	return out
}
