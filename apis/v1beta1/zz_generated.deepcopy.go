...
func (in *TargetAllocatorMetricsConfig) DeepCopyInto(out *TargetAllocatorMetricsConfig) {
	*out = *in
	if in.OTLP != nil {
		...
		*out = new(TargetAllocatorOTLPConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetAllocatorOTLPConfig) DeepCopyInto(out *TargetAllocatorOTLPConfig) {
	*out = *in
	if in.Headers != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetAllocatorOTLPConfig.
func (in *TargetAllocatorOTLPConfig) DeepCopy() *TargetAllocatorOTLPConfig {
	if in == nil {
		return nil
	}
	out := new(TargetAllocatorOTLPConfig)
