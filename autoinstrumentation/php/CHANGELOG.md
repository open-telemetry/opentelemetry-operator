# Changelog — PHP auto-instrumentation image

All notable changes to the OpenTelemetry PHP auto-instrumentation image
(`ghcr.io/open-telemetry/opentelemetry-operator/autoinstrumentation-php`) are
...
- Initial changelog entry for the OpenTelemetry PHP auto-instrumentation image.
