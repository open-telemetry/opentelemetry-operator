...
func GetAllTargetsByJob(job string, cMap map[string][]strategy.TargetItem, allocator *Allocator) map[string]strategy.CollectorJSON {
...
func GetAllTargetsByCollectorAndJob(collector string, job string, cMap map[string][]strategy.TargetItem, allocator *Allocator) []strategy.TargetGroupJSON {
