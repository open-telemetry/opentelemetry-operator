...
require (
	...
	github.com/open-telemetry/opentelemetry-operator v0.40.0 // indirect
	...
	github.com/prometheus-community/prom-label-proxy v0.4.0 // indirect
	...
	github.com/thanos-io/thanos v0.23.1 // indirect
