...
<table>
    ...
    <tbody><tr>
        ...
        <td>boolean</td>
        <td>
          CreateServiceMonitors specifies if ServiceMonitors should be created for the OpenTelemetry Collector. The operator.observability.prometheus feature gate must be enabled to use this feature.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
