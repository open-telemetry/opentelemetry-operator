...
Failure to set this value causes instrumentation injection to abort, leaving the original pod unchanged.<br/>
        ...
        <td><b><a href="#instrumentationspecinjector">injector</a></b></td>
        <td>object</td>
        <td>
          Injector defines configuration for the injector-based auto-instrumentation.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#instrumentationspecinjectorenvindex">env</a></b></td>
        <td>[]object</td>
        <td>
...
If the former var had been defined, then the other vars would be ignored.<br/>
        ...
        <td>string</td>
        <td>
          Image is a container image with auto-instrumentation injector.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#instrumentationspecinjectorresources">resources</a></b></td>
        <td>object</td>
        <td>
          Resources describes the compute resource requirements.<br/>
        </td>
        ...
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplate">volumeClaimTemplate</a></b></td>
        <td>object</td>
        <td>
          VolumeClaimTemplate defines a ephemeral volume used for auto-instrumentation.
If omitted, an emptyDir is used with size limit VolumeSizeLimit<br/>
...
### Instrumentation.spec.injector.env[index]
<sup><sup>[↩ Parent](#instrumentationspecinjector)</sup></sup>
...
Defaults to "".<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorenvindexvaluefrom">valueFrom</a></b></td>
        <td>object</td>
        <td>
          Source for the environment variable's value. Cannot be used if value is not empty.<br/>
        </td>
...
### Instrumentation.spec.injector.env[index].valueFrom
<sup><sup>[↩ Parent](#instrumentationspecinjectorenvindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#instrumentationspecinjectorenvindexvaluefromconfigmapkeyref">configMapKeyRef</a></b></td>
        <td>object</td>
        <td>
          Selects a key of a ConfigMap.<br/>
        </td>
        ...
        <td><b><a href="#instrumentationspecinjectorenvindexvaluefromfieldref">fieldRef</a></b></td>
        <td>object</td>
        <td>
          Selects a field of the pod: supports metadata.name, metadata.namespace, `metadata.labels['<KEY>']`, `metadata.annotations['<KEY>']`,
spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorenvindexvaluefromresourcefieldref">resourceFieldRef</a></b></td>
        <td>object</td>
        <td>
          Selects a resource of the container: only resources limits and requests
(limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorenvindexvaluefromsecretkeyref">secretKeyRef</a></b></td>
        <td>object</td>
        <td>
          Selects a key of a secret in the pod's namespace<br/>
        </td>
...
### Instrumentation.spec.injector.env[index].valueFrom.configMapKeyRef
<sup><sup>[↩ Parent](#instrumentationspecinjectorenvindexvaluefrom)</sup></sup>
...
### Instrumentation.spec.injector.env[index].valueFrom.fieldRef
<sup><sup>[↩ Parent](#instrumentationspecinjectorenvindexvaluefrom)</sup></sup>
...
### Instrumentation.spec.injector.env[index].valueFrom.resourceFieldRef
<sup><sup>[↩ Parent](#instrumentationspecinjectorenvindexvaluefrom)</sup></sup>
...
### Instrumentation.spec.injector.env[index].valueFrom.secretKeyRef
<sup><sup>[↩ Parent](#instrumentationspecinjectorenvindexvaluefrom)</sup></sup>
...
### Instrumentation.spec.injector.resources
<sup><sup>[↩ Parent](#instrumentationspecinjector)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#instrumentationspecinjectorresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
### Instrumentation.spec.injector.resources.claims[index]
<sup><sup>[↩ Parent](#instrumentationspecinjectorresources)</sup></sup>
...
### Instrumentation.spec.injector.volumeClaimTemplate
<sup><sup>[↩ Parent](#instrumentationspecinjector)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatespec">spec</a></b></td>
        <td>object</td>
        <td>
          The specification for the PersistentVolumeClaim. The entire content is
copied unchanged into the PVC that gets created from this
...
are also valid here.<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatemetadata">metadata</a></b></td>
        <td>object</td>
        <td>
          May contain labels and annotations that will be copied into the PVC
when creating it. No other fields are allowed and will be rejected during
...
### Instrumentation.spec.injector.volumeClaimTemplate.spec
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplate)</sup></sup>
...
More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatespecdatasource">dataSource</a></b></td>
        <td>object</td>
        <td>
          dataSource field can be used to specify either:
* An existing VolumeSnapshot object (snapshot.storage.k8s.io/VolumeSnapshot)
...
If the namespace is specified, then dataSourceRef will not be copied to dataSource.<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatespecdatasourceref">dataSourceRef</a></b></td>
        <td>object</td>
        <td>
          dataSourceRef specifies the object from which to populate the volume with data, if a non-empty
volume is desired. This may be any object from a non-empty API group (non
...
* While dataSource only allows two specific types of objects, dataSourceRef
  allows any non-core object, as well as PersistentVolumeClaim objects.<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatespecresources">resources</a></b></td>
        <td>object</td>
        <td>
          resources represents the minimum resources the volume should have.
If RecoverVolumeExpansionFailure feature is enabled users are allowed to specify resource requirements
...
More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources<br/>
        ...
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatespecselector">selector</a></b></td>
        <td>object</td>
        <td>
          selector is a label query over volumes to consider for binding.<br/>
        </td>
...
### Instrumentation.spec.injector.volumeClaimTemplate.spec.dataSource
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplatespec)</sup></sup>
...
### Instrumentation.spec.injector.volumeClaimTemplate.spec.dataSourceRef
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplatespec)</sup></sup>
...
### Instrumentation.spec.injector.volumeClaimTemplate.spec.resources
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplatespec)</sup></sup>
...
### Instrumentation.spec.injector.volumeClaimTemplate.spec.selector
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplatespec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#instrumentationspecinjectorvolumeclaimtemplatespecselectormatchexpressionsindex">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
          matchExpressions is a list of label selector requirements. The requirements are ANDed.<br/>
        </td>
...
### Instrumentation.spec.injector.volumeClaimTemplate.spec.selector.matchExpressions[index]
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplatespecselector)</sup></sup>
...
### Instrumentation.spec.injector.volumeClaimTemplate.metadata
<sup><sup>[↩ Parent](#instrumentationspecinjectorvolumeclaimtemplate)</sup></sup>
