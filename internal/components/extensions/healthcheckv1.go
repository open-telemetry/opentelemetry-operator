...
func healthCheckV1AddressDefaulter(logger logr.Logger, tls components.TLSProfile, defaultRecAddr string, port int32, config healthcheckV1Config) (map[string]interface{}, error) {
	if config.Endpoint == "" {
