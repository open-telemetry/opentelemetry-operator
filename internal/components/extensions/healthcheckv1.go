...
func healthCheckV1AddressDefaulter(_ logr.Logger, _ *components.DefaultConfig, defaultRecAddr string, port int32, config healthcheckV1Config) (map[string]interface{}, error) {
	if config.Endpoint == "" {
