...
func endpointDefaulter(_ logr.Logger, tls components.TLSProfile, defaultRecAddr string, port int32, config *JaegerQueryExtensionConfig) (map[string]interface{}, error) {
	if config == nil {
