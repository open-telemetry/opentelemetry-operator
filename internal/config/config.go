...
type Config struct {
	...
	// the k8s distribution at the same version as CollectorImage.
...
func New() Config {
	...
	return Config{
		...
		AutoInstrumentationPhpImage:         fmt.Sprintf("ghcr.io/opentelemetry-php/autoinstrumentation-php:%s", v.AutoInstrumentationPhp),
