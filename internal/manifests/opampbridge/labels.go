...
// SelectorLabels return the common labels to all objects that are part of a OpAMPBridge to use as selector.
// Selector labels are immutable for Deployment, therefore, no labels in selector should be
