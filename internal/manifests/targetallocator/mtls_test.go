...
func TestIsMTLSEnabled_DefaultsUseCertManagerToTrue(t *testing.T) {
	...
	assert.True(t, isMTLSEnabled(cfg, collector))
}

func TestIsMTLSEnabled_DisabledWhenUseCertManagerFalse(t *testing.T) {
	...
	assert.False(t, isMTLSEnabled(cfg, collector))
}
