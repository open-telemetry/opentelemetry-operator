...
func main() {
	...
	pflag.StringVar(&sidecarConfigPrepperImage, "sidecar-config-prepper-image", "busybox:latest", "The default container image that is used to prepare config file for the collector config. The image uses sh, echo and cat commands")
