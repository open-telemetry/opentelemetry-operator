...
func main() {
	...
	pflag.BoolVar(&enableApacheHTTPInstrumentation, "enable-apache-http-instrumentation", false, "controls whether the operator supports Apache HTTPD auto-instrumentation")
