...
func expectedServiceMonitors(ctx context.Context, params reconcileutil.Params, expected []*monitoringv1.ServiceMonitor) error {
...
func deleteServiceMonitors(ctx context.Context, params reconcileutil.Params, expected []*monitoringv1.ServiceMonitor) error {
