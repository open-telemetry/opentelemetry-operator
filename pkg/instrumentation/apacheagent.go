...
func injectApacheagent(logger logr.Logger, apacheSpec v1alpha1.Apache, pod corev1.Pod, index int, otlpEndpoint string, resourceMap map[string]string) corev1.Pod {
...
// Calculate Apache agent configuration file based on attributes provided by the injection rules
// and by the pod values
func getApacheOtelConfig(pod corev1.Pod, apacheSpec v1alpha1.Apache, index int, otelEndpoint string, resourceMap map[string]string) string {
	template := `
