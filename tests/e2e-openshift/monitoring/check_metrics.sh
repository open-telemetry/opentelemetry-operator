...
metrics="otelcol_process_uptime otelcol_process_cpu_seconds otelcol_process_memory_rss otelcol_process_runtime_heap_alloc_bytes otelcol_process_runtime_total_alloc_bytes otelcol_process_runtime_total_sys_memory_bytes otelcol_exporter_sent_spans otelcol_exporter_sent_log_records otelcol_exporter_sent_metric_points otelcol_receiver_accepted_spans otelcol_receiver_refused_spans otelcol_receiver_accepted_log_records otelcol_receiver_refused_log_records otelcol_receiver_accepted_metric_points otelcol_receiver_refused_metric_points otelcol_processor_accepted_spans otelcol_processor_accepted_log_records otelcol_processor_accepted_metric_points controller_runtime_reconcile_time_seconds_count{controller=\"opentelemetrycollector\"} controller_runtime_reconcile_total{controller=\"opentelemetrycollector\",result=\"success\"} workqueue_work_duration_seconds_count{controller=\"opentelemetrycollector\",name=\"opentelemetrycollector\"}"
